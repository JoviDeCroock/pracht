...
For contributors, `src/plugin-codegen.ts` remains the stable virtual-module
generator facade and owns server/development assembly. Client hydration and
islands bootstraps live in `plugin-client-codegen.ts`; their shared generated
route-loader hint helper lives in `plugin-codegen-route-hints.ts`. Lazy
route/API/capability registry globs are generated by
