...
- [#361](https://github.com/JoviDeCroock/pracht/pull/361) [`d0ab66e`](https://github.com/JoviDeCroock/pracht/commit/d0ab66ee65c7cb7a6a163f3220b6c668e40717ff) Thanks [@JoviDeCroock](https://github.com/JoviDeCroock)! - Add `useBlocker()`, which stops a client navigation before it commits so a route can guard unsaved work. It covers `<Link>` clicks, `useNavigate()`, back/forward traversals, and — unless you opt out — document unloads via `beforeunload`; resolve the returned blocker with `proceed()` or `reset()`.
...
- [#373](https://github.com/JoviDeCroock/pracht/pull/373) [`0b42d62`](https://github.com/JoviDeCroock/pracht/commit/0b42d622b55757eb73f19c3cff134ee42bfbcf18) Thanks [@JoviDeCroock](https://github.com/JoviDeCroock)! - Speed up link-heavy server rendering by compiling typed route href lookups once per route table.
