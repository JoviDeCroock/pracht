import { resolveServerEnvSource, setServerEnv } from "@pracht/capabilities/server/internal";
 ...
 *
 * The installed source lives in `@pracht/capabilities/server/internal`, so the
 * capability core (confirmation secrets, standalone hosts) reads the exact
 * same environment the adapter installed.
 */
export { setServerEnv };
