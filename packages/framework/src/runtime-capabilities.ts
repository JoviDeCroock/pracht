 ...
 *
 * The implementation lives in `@pracht/capabilities/server` — the
...
import { invokeCapability as invokeCapabilityUntyped } from "@pracht/capabilities/server";
import type {
...
import type { InvokeCapabilityContext } from "@pracht/capabilities/server";
