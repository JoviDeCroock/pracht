...
collection output. Generated artifact paths also cannot overlap files in
...
file/directory collisions fail across collections, and Pracht's internal
content-header path is reserved.
