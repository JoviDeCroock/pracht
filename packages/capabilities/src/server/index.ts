/**
 * `@pracht/capabilities/server` — the capability server core.
 *
 ...
 * exports; `createCapabilityHost()` mounts the same pipeline in any other
 * server (Express, Hono, Next.js, a bare Worker) with capabilities registered
 * at runtime.
 *
