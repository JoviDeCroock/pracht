/**
 * Offset-preserving JavaScript source scanning and inline data-literal parsing.
 * Kept independent from capability projection so syntax support has one home.
 */
