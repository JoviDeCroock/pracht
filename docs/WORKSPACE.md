...
- **Claude Code skills** — Three repo-local skills in `skills/` (mirrored by
  the docs example's `agentSkills` Vite plugin into its public folder so they
  are served at `/skills/<name>/SKILL.md`, indexed via
