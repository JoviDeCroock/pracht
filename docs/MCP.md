...
| `generate_middleware` | `cwd?`, `name`                                                                                                      | Files created and updated. Manifest apps accept named middleware; pages apps accept `_middleware` for the root middleware applied to every page route. |
