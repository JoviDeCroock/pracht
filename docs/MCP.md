...
| `inspect_capabilities` | `cwd?`                                                                                                          | Registered capabilities: name, effect class, exposure transports, HTTP path, middleware, source file, input/output JSON Schemas, plus `mcpEndpoint`, `mcpDestructive`, and `mcpUnavailableReasons`. Same as `pracht inspect capabilities --json`. |
