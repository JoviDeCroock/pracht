...
- **Preact-first** — 0 KB of client JavaScript on a static route, 7.4 KB gzip with islands, 16.2 KB fully hydrated with the router. Measured by `pnpm bench` in this repo and gated in CI, not asserted.
