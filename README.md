...
- **Preact-first** — 0 KB of client JavaScript on a static route, 7.5 KB gzip with islands, 17.5 KB fully hydrated with the router. Measured by `pnpm bench` in this repo and gated in CI, not asserted.
