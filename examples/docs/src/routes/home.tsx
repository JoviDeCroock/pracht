...
const FEATURES: { Icon: Icon; title: string; desc: string }[] = [
  ...
  },
  {
    Icon: IconAtom,
    title: "Preact-First",
    desc: "Full hooks, JSX, and the Preact ecosystem on a runtime you can size: 0 KB on a static route, 17.5 KB gzip fully hydrated. Both measured by pnpm bench, both gated in CI.",
  },
  {
    Icon: IconBolt,
      ...
      <section class="section ladder-section">
        <div class="section-inner">
          ...
          <p class="ladder-note">
            ...
            with <code>client: {"{ prefetch: false }"}</code> takes full hydration to 16.0 KB.
