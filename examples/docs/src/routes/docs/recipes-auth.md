...
- **API routes** — handle login/logout form submissions
...
The login API route validates credentials and sets the session cookie:
...
The login page renders the form and points it at the login API route:
