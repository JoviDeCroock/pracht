---
title: Middleware
lead: Server-side request interceptors that run before loaders and API route handlers. Use them for authentication, redirects, request validation, and context enrichment.
