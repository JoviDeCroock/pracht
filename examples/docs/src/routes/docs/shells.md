...
When navigating between routes that share the same shell, previte preserves the shell and only re-renders the route content. When crossing shell boundaries, the full page tree is re-rendered.
